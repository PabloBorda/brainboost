...
<div id="product_comments_block_extra" class="no-print" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
	...
	<ul class="comments_advices">
		{if $nbComments != 0}
			<li>
				<a href="#idTab5" class="reviews tooltip" title="{l s='Read reviews' mod='productcomments'}  ({$nbComments})">
		...
		{if ($too_early == false AND ($is_logged OR $allow_guests))}
			<li>
				<a class="open-comment-form tooltip" href="#new_comment_form" title="{l s='Write a review' mod='productcomments'}">
