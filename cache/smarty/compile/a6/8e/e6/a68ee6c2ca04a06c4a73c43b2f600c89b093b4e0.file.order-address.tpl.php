<?php /* Smarty version Smarty-3.1.19, created on 2017-05-23 01:34:24
         compiled from "/home/brainboo/public_html/modules/bestkit_opc/views/templates/front/order-address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:174536706959238390d70119-39983095%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a68ee6c2ca04a06c4a73c43b2f600c89b093b4e0' => 
    array (
      0 => '/home/brainboo/public_html/modules/bestkit_opc/views/templates/front/order-address.tpl',
      1 => 1486138161,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '174536706959238390d70119-39983095',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59238390f19544_52874850',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59238390f19544_52874850')) {function content_59238390f19544_52874850($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/brainboo/public_html/tools/smarty/plugins/modifier.escape.php';
?>

<?php $_smarty_tpl->tpl_vars["back_order_page"] = new Smarty_variable("order-opc.php", null, 0);?>

<h1 class="page-heading"><span class="heading-counter heading-counter-1">1</span><?php echo smartyTranslate(array('s'=>'Addresses','mod'=>'bestkit_opc'),$_smarty_tpl);?>
</h1>

<div class="box box-opc">
    <?php if (!$_smarty_tpl->tpl_vars['opc']->value) {?>
        <?php $_smarty_tpl->tpl_vars['current_step'] = new Smarty_variable('address', null, 0);?>
        <?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?><?php echo smartyTranslate(array('s'=>'Addresses','mod'=>'bestkit_opc'),$_smarty_tpl);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
        ...
        <h1 class="page-heading"><?php echo smartyTranslate(array('s'=>'Addresses','mod'=>'bestkit_opc'),$_smarty_tpl);?>
</h1>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="address_delivery select form-group selector1">
                                <label for="id_address_delivery"><?php if ($_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()) {?><?php echo smartyTranslate(array('s'=>'Choose a billing address:','mod'=>'bestkit_opc'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Choose a delivery address:','mod'=>'bestkit_opc'),$_smarty_tpl);?>
<?php }?></label>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div id="address_invoice_form" class="select form-group selector1"<?php if ($_smarty_tpl->tpl_vars['cart']->value->id_address_invoice==$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery) {?> style="display: none;"<?php }?>>
                                <?php if (count($_smarty_tpl->tpl_vars['addresses']->value)>1) {?>
                                    <label for="id_address_invoice" class="strong"><?php echo smartyTranslate(array('s'=>'Choose a billing address:','mod'=>'bestkit_opc'),$_smarty_tpl);?>
</label>
...
" class="button button-small btn btn-default">
                            <span>
                                <?php echo smartyTranslate(array('s'=>'Add a new address','mod'=>'bestkit_opc'),$_smarty_tpl);?>
                    ...
                    <div>
                        <div class="col-xs-12 col-sm-12">
                            ...
                            <p class="checkbox addressesAreEquals"<?php if ($_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()) {?> style="display:none;"<?php }?>>
                                ...
                                <label for="addressesAreEquals"><?php echo smartyTranslate(array('s'=>'Use the delivery address as the billing address.','mod'=>'bestkit_opc'),$_smarty_tpl);?>
</label>
                            </p>
                        </div>
                    </div> <!-- end row -->
...
" title="<?php echo smartyTranslate(array('s'=>'Add','mod'=>'bestkit_opc'),$_smarty_tpl);?>
" class="button button-small btn btn-default">
                            <span><?php echo smartyTranslate(array('s'=>'Add a new address','mod'=>'bestkit_opc'),$_smarty_tpl);?>
<i class="icon-chevron-right right"></i></span>
                        </a>
                    </p>
                    <?php if (!$_smarty_tpl->tpl_vars['opc']->value) {?>
                        <div id="ordermsg" class="form-group">
                            <label><?php echo smartyTranslate(array('s'=>'If you would like to add a comment about your order, please write it in the field below.','mod'=>'bestkit_opc'),$_smarty_tpl);?>
</label>
...
" />
                    <a href="<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&back=";?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['back']->value, false);?>
<?php }?><?php $_tmp3=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink($_smarty_tpl->tpl_vars['back_order_page']->value,true,null,"step=0".$_tmp3), ENT_QUOTES, 'UTF-8', true);?>
...
" class="button-exclusive btn btn-default">
                    ...
                    <button type="submit" name="processAddress" class="button btn btn-default button-medium">
                        <span><?php echo smartyTranslate(array('s'=>'Proceed to checkout','mod'=>'bestkit_opc'),$_smarty_tpl);?>
<i class="icon-chevron-right right"></i></span>
                    </button>
                </p>
        </form>
...
<?php $_smarty_tpl->smarty->_tag_stack[] = array('addJsDefL', array('name'=>smarty_modifier_escape('txtProduct', false))); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0]->addJsDefL(array('name'=>smarty_modifier_escape('txtProduct', false)), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
<?php echo smartyTranslate(array('s'=>'product','js'=>1,'mod'=>'bestkit_opc'),$_smarty_tpl);?>
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0]->addJsDefL(array('name'=>smarty_modifier_escape('txtProduct', false)), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php $_smarty_tpl->smarty->_tag_stack[] = array('addJsDefL', array('name'=>smarty_modifier_escape('txtProducts', false))); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0]->addJsDefL(array('name'=>smarty_modifier_escape('txtProducts', false)), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
<?php echo smartyTranslate(array('s'=>'products','js'=>1,'mod'=>'bestkit_opc'),$_smarty_tpl);?>
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0]->addJsDefL(array('name'=>smarty_modifier_escape('txtProducts', false)), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php $_smarty_tpl->smarty->_tag_stack[] = array('addJsDefL', array('name'=>smarty_modifier_escape('CloseTxt', false))); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0]->addJsDefL(array('name'=>smarty_modifier_escape('CloseTxt', false)), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
<?php echo smartyTranslate(array('s'=>'Submit','js'=>1,'mod'=>'bestkit_opc'),$_smarty_tpl);?>
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0]->addJsDefL(array('name'=>smarty_modifier_escape('CloseTxt', false)), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array('default', null, null); ob_start(); ?><h3 class="page-subheading"><?php echo smartyTranslate(array('s'=>'Your billing address','js'=>1,'mod'=>'bestkit_opc'),$_smarty_tpl);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array('default', null, null); ob_start(); ?><h3 class="page-subheading"><?php echo smartyTranslate(array('s'=>'Your delivery address','js'=>1,'mod'=>'bestkit_opc'),$_smarty_tpl);?>
</h3><?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
...
" title="<?php echo smartyTranslate(array('s'=>'Update','js'=>1,'mod'=>'bestkit_opc'),$_smarty_tpl);?>
"><span><?php echo smartyTranslate(array('s'=>'Update','js'=>1,'mod'=>'bestkit_opc'),$_smarty_tpl);?>
