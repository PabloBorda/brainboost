<?php /* Smarty version Smarty-3.1.19, created on 2017-03-06 21:13:28
         compiled from "/home/brainboo/public_html/themes/elation-advance-touch/category.tpl" */ ?>
<?php /*%%SmartyHeaderCode:160994051158bdd0f8e74247-49442272%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5f411327a7d7f717b6408da9541e403aec7aad43' => 
    array (
      0 => '/home/brainboo/public_html/themes/elation-advance-touch/category.tpl',
      1 => 1486138161,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '160994051158bdd0f8e74247-49442272',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58bdd0f90c3453_82750418',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58bdd0f90c3453_82750418')) {function content_58bdd0f90c3453_82750418($_smarty_tpl) {?>
...
" class="lnk_more"><?php echo smartyTranslate(array('s'=>'More'),$_smarty_tpl);?>
                    ...
                    <?php } else { ?>
                    <!-- Category image -->
                    <div class="content_scene_cat_bg" <?php if ($_smarty_tpl->tpl_vars['category']->value->id_image) {?>style="background:url(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getCatImageLink($_smarty_tpl->tpl_vars['category']->value->link_rewrite,$_smarty_tpl->tpl_vars['category']->value->id_image,'category_ebt'), ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?></span><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./category-count.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
			...
			<!-- Subcategories -->
			<div id="subcategories" class="eb-wrapper">
...
" class="img">
							<?php if ($_smarty_tpl->tpl_vars['subcategory']->value['id_image']) {?>
								<img class="replace-2x" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getCatImageLink($_smarty_tpl->tpl_vars['subcategory']->value['link_rewrite'],$_smarty_tpl->tpl_vars['subcategory']->value['id_image'],'medium_ebt'), ENT_QUOTES, 'UTF-8', true);?>
" alt="" />
							<?php } else { ?>
								<img class="replace-2x" src="<?php echo $_smarty_tpl->tpl_vars['img_cat_dir']->value;?>
default-medium_ebt.jpg" alt="" />
							<?php }?>
						</a>
						</div>
...
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['subcategory']->value['name'],25,'...'), ENT_QUOTES, 'UTF-8', true),350);?>
			...
			<div class="content_sortPagiBar clearfix eb-wrapper">
				...
				<div class="top-pagination-content clearfix eb-wrapper">
			...
			<div class="content_sortPagiBar eb-wrapper">
		...
		<?php } elseif ($_smarty_tpl->tpl_vars['category']->value->id) {?>
			<p class="alert alert-warning eb-wrapper"><?php echo smartyTranslate(array('s'=>'This category is currently unavailable.'),$_smarty_tpl);?>
</p>
		<?php }?>
	</div>
<?php }?><?php }} ?>
