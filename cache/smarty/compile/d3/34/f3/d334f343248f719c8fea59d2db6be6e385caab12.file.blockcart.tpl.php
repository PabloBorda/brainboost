<?php /* Smarty version Smarty-3.1.19, created on 2017-02-28 16:49:39
         compiled from "/home/brainboo/public_html/themes/elation-advance-touch/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:133751141358b5aa23aeae23-68144223%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd334f343248f719c8fea59d2db6be6e385caab12' => 
    array (
      0 => '/home/brainboo/public_html/themes/elation-advance-touch/modules/blockcart/blockcart.tpl',
      1 => 1486138161,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '133751141358b5aa23aeae23-68144223',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58b5aa23e970e5_77391715',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b5aa23e970e5_77391715')) {function content_58b5aa23e970e5_77391715($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/brainboo/public_html/tools/smarty/plugins/modifier.replace.php';
...
<div class="<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> header_user_catalog<?php }?> cart_block" style="//display:block;">
<?php }?>
...
" rel="nofollow">
			...
			<span class="ajax_cart_no_product<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value>0) {?> unvisible<?php }?>"></span>
...
<?php } else { ?>0<?php }?>" id="cart_block_product_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
...
?>
												<li name="customization">
													<div id="deleteCustomizableProduct_<?php echo intval($_smarty_tpl->tpl_vars['id_customization']->value);?>
...
" rel="nofollow">&nbsp;</a>
						...
						<?php }?>
						<p class="cart_block_no_products<?php if ($_smarty_tpl->tpl_vars['products']->value) {?> unvisible<?php }?>" id="cart_block_no_products">
...
<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&$_smarty_tpl->tpl_vars['active_overlay']->value==1) {?>
	<div id="layer_cart" style="z-index:100000;">
		<div class="clearfix">
