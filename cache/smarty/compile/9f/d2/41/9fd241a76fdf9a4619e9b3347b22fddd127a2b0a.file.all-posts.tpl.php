<?php /* Smarty version Smarty-3.1.19, created on 2017-02-02 11:54:56
         compiled from "/var/www/html/modules/blockblog/views/templates/front/all-posts.tpl" */ ?>
<?php /*%%SmartyHeaderCode:191008818458931e10465332-75459743%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9fd241a76fdf9a4619e9b3347b22fddd127a2b0a' => 
    array (
      0 => '/var/www/html/modules/blockblog/views/templates/front/all-posts.tpl',
      1 => 1475588147,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '191008818458931e10465332-75459743',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58931e105959b7_90611086',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58931e105959b7_90611086')) {function content_58931e105959b7_90611086($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/tools/smarty/plugins/modifier.date_format.php';
?>
...
<h2 class="background-none"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['meta_title']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</h2>
<?php } else { ?>
...
<?php if ($_smarty_tpl->tpl_vars['blockblogis_search']->value==1) {?>
<div class="clear"></div>
<h3 class="float-right"><?php echo smartyTranslate(array('s'=>'Results for','mod'=>'blockblog'),$_smarty_tpl);?>
 "<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['blockblogsearch']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"</h3>
<div class="clear"></div>
<?php }?>
...
">
                    ...
                    <div class="col-sm-<?php if (strlen($_smarty_tpl->tpl_vars['post']->value['img'])>0) {?>7<?php } else { ?>12<?php }?>-custom">
                        <div class="body-blog">
                            <?php echo mb_convert_encoding(htmlspecialchars(substr($_smarty_tpl->tpl_vars['post']->value['content'],0,$_smarty_tpl->tpl_vars['blockblogblog_pl_tr']->value), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
