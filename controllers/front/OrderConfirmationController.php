...
require '../../ds/elasticsearch/ElasticSearch.php';
...
class OrderConfirmationControllerCore extends FrontController
{
    ...
    public function displayOrderConfirmation()
    {
        if (Validate::isUnsignedId($this->id_order)) {
            ...
            insertOrderToElasticSearch($order);
        }
        return false;
    }
    ...
    private function insertOrderToElasticSearch($order){
        ...
        curl_setopt($ch, CURLOPT_CAINFO,'../../ds/elasticsearch/cacert.pem');
