...
class Zendesk extends Module
{
        ...
        if ($need['to_install']) {
            ...
            if (isset($ret->ticket_field->id)) {
                ...
                if (isset($install->id)) {
                    ...
                    $this->context->controller->errors[]  = $this->l('Error during install app');
                }
            } else {
                $this->context->controller->errors[]  = $this->l('Can\'t process the creation of the user field.');
            }
        }
    ...
    public function hookDisplayBackOfficeHeader()
    {
        ...
        } elseif (isset($this->context->controller) && $this->context->controller instanceof AdminCustomerThreadsController) {
