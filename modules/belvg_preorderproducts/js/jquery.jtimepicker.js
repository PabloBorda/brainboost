...
(function($) {
    $.fn.extend({
        ...
        jtimepicker: function(options) {
            ...
            var defaults = {
                clockIcon: '../modules/preorderproducts/images/icon_clock_2.gif',
            ...
            return this.each(function() {
                ...
                html += $this.createCombo(o.hourCombo, o.hourMode, o.hourInterval, /* o.hourDefaultValue */hourcombo);
                html += $this.createCombo(o.minCombo, o.minLength, o.minInterval, /* o.minDefaultValue */mincombo);
                if (o.secView) {
                    sliderData.push({'label':o.secLabel, 'slider':o.secSlider, 'combo':o.secCombo});
                    html += $this.createCombo(o.secCombo, o.secLength, o.secInterval, /* o.secDefaultValue */seccombo);
                }
    ...
    $.fn.createSliderWrap = function(data) {
        ...
        $.each(data, function(i, item) {
            html += '   <div class="clear"><label>' + item.label + ':</label> <p class="' + item.slider + '"></p></div>';
        });
            html += '</div>';
