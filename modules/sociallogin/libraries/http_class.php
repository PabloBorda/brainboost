...
class http_class
{
    ...
    public $user_agent = 'httpclient (http://www.phpclasses.org/httpclient $Revision: 1.93 $)';
    public $accept = '';
    ...
    protected function CookieEncode($value, $name)
    {
        return $name ? str_replace('=', '%25', $value) : str_replace(';', '%3B', $value);
    }

    protected function SetError($error, $error_code = HTTP_CLIENT_ERROR_UNSPECIFIED_ERROR)
    {
    ...
    protected function SetPHPError($error, &$php_error_message, $error_code = HTTP_CLIENT_ERROR_UNSPECIFIED_ERROR)
    {
    ...
    protected function SetDataAccessError($error, $check_connection = 0)
    {
        $this->error = $error;
    ...
    protected function ReadChunkSize()
    {
    ...
    protected function Resolve($domain, &$ip, $server_type)
    {
