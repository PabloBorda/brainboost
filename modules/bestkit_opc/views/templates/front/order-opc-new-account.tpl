    ...
    <form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:false}" method="post" id="login_form" class="box box-opc">
        <fieldset>
            ...
            <div id="login_form_content">
				    					<button class="btn azm-social azm-size-48 azm-0 azm-facebook" onclick="window.open('http://brainboost.ie/index.php?p=facebook&amp;back=&amp;request_uri=%2Findex.php%3Fid_product%3D83%26controller%3Dproduct&amp;utm_source=button&amp;utm_medium=facebook&amp;utm_campaign=social_login&amp;fc=module&amp;module=sociallogin&amp;controller=login', '_blank', 'menubar=no, status=no, copyhistory=no, width=640, height=640, top=220, left=640')">
				    						<i class="fa fa-facebook"></i>
				    					</button>
				    					<button class="btn azm-social azm-size-48 azm-0 azm-google-plus" onclick="window.open('http://brainboost.ie/index.php?p=google&amp;back=&amp;request_uri=%2Findex.php%3Fid_product%3D83%26controller%3Dproduct&amp;utm_source=button&amp;utm_medium=google&amp;utm_campaign=social_login&amp;fc=module&amp;module=sociallogin&amp;controller=login', '_blank', 'menubar=no, status=no, copyhistory=no, width=640, height=640, top=220, left=640')">
				    						<i class="fa fa-google-plus"></i>
				    					</button>
				    					<button class="btn azm-social azm-size-48 azm-0 azm-instagram" onclick="window.open('http://brainboost.ie/index.php?p=instagram&amp;back=&amp;request_uri=%2Findex.php%3Fid_product%3D83%26controller%3Dproduct&amp;utm_source=button&amp;utm_medium=instagram&amp;utm_campaign=social_login&amp;fc=module&amp;module=sociallogin&amp;controller=login', '_blank', 'menubar=no, status=no, copyhistory=no, width=640, height=640, top=220, left=640')">
				    						<i class="fa fa-instagram"></i>
				    					</button>
				    					<button class="btn azm-social azm-size-48 azm-0 azm-linkedin" onclick="window.open('http://brainboost.ie/index.php?p=linkedin&amp;back=&amp;request_uri=%2Findex.php%3Fid_product%3D83%26controller%3Dproduct&amp;utm_source=button&amp;utm_medium=linkedin&amp;utm_campaign=social_login&amp;fc=module&amp;module=sociallogin&amp;controller=login', '_blank', 'menubar=no, status=no, copyhistory=no, width=640, height=640, top=220, left=640')">
