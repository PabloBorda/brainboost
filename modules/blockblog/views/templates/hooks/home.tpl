...
<div {if $blockblogis_ps15 !=0}id="left_column"{/if}>
	<div id="blockblogblock_block_left"
         ...
         >
		<h4 class="title_block {if $blockblogrsson == 0}rss-home-block{/if}">
		...
		{if count($blockblogposts) > 0}
	     ...
	     {foreach from=$blockblogposts item=items name=myLoop1}
		   ...
		   <li class="vertical-blocks-blog" class="{if $smarty.foreach.myLoop.first}first_item{elseif $smarty.foreach.myLoop.last}last_item{else}item{/if}">
