...
{if $blockblogcat_left == 1}

	<div id="blockblogcat_block_left" class="block margin-top-10 {if $blockblogis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if}" >
...
{if $blockblogposts_left == 1}

	<div id="blockblogposts_block_left" class="block {if $blockblogis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if} blockblog-block" >
		<h4 class="title_block">
...
{if $blockblogcom_left == 1}
<div id="blockblogcomm_block_left" class="last-comments-block block {if $blockblogis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if}" >
...
{if $blockblogarch_left == 1}
<div id="blockblogarch_block_left" class="block {if $blockblogis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if} search_blog" >
...
{if $blockblogsearch_left == 1}
<div id="blockblogsearch_block_left" class="block {if $blockblogis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if} search_blog" >
