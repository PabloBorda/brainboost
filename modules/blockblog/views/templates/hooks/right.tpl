...
{if $blockblogcat_right == 1}

	<div id="blockblogcat_block_right" class="block margin-top-10 {if $blockblogis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if}" >
...
{if $blockblogposts_right == 1}

	<div id="blockblogposts_block_right" class="block {if $blockblogis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if} blockblog-block" >
        <h4 class="title_block">
...
{if $blockblogcom_right == 1}
<div id="blockblogcomm_block_right" class="last-comments-block block {if $blockblogis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if}" >
...
{if $blockblogarch_right == 1}
<div id="blockblogarch_block_right" class="block {if $blockblogis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if} search_blog" >
    <h4 class="title_block">{l s='Blog Archives' mod='blockblog'}</h4>
...
{if $blockblogsearch_right == 1}
<div id="blockblogsearch_block_right" class="block {if $blockblogis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if} search_blog" >
    <h4 class="title_block">{l s='Search in Blog' mod='blockblog'}</h4>
