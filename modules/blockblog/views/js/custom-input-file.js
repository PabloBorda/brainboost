...
var inputNumber = 1;
        ...
        function HandleChanges(id)
        {
            ...
            if (ext){
                ...
                fileName.style.background = 'url(../modules/blockblog/views/img/input/icons.png) no-repeat 0 -'+pos+'px';
        ...
        function wrap(element)
        {
            ...
            fileName.style.background = 'url(../modules/blockblog/views/img/input/icons.png)';
